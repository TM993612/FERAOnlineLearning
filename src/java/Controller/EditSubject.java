...
public class EditSubject extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditSubject</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditSubject at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Subject subject = dao.getSubjectByID(subID);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            SubjectDAO dao = new SubjectDAO();
            dao.updateSubject(newSubjectName, newDesc, newPicture, subID);
