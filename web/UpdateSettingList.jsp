                        ...
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            <div class="intro-y col-span-12 lg:col-span-6">
                                <div class="intro-y box p-5">
                                    <form action="SettingListEdit" method="post">
                                        <div><label for="crud-form-1" class="form-label">Setting ID</label>
                                            <input name="settingId" value="${settingLoad.settingId}" readonly=""
                                                   id="crud-form-1" type="text" class="form-control w-full"
                                                   placeholder="Input text">
                                        </div>

                                        <div class="mt-3"><label for="crud-form-3" class="form-label">Setting Name</label>
                                            <div class="input-group"><input name="settingName" value="${settingLoad.settingName}" id="crud-form-3" type="text" class="form-control"
                                        ...
                                        <div class="mt-3"><label for="crud-form-3" class="form-label">Setting Type</label>
                                            <div class="input-group"><input name="settingType" value="${settingLoad.settingType}" id="crud-form-3" type="text" class="form-control"
                                                                            placeholder="Quantity" aria-describedby="input-group-1">
