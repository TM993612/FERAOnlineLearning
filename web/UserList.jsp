                        ...
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            ...
                            <div class="intro-y col-span-12 overflow-auto lg:overflow-visible" style="overflow-x: auto">
                                <table class="table table-report -mt-2">
                                    <thead>
                                        <!--int userID, String username, String password, int roleID, String fullName, String address, String aboutMe, String dob, boolean gender, String education, String img, String email, boolean active-->
                                        <tr>
                                            ...
                                            <th class="whitespace-nowrap">ABOUT ME</th>
                                            <th class="whitespace-nowrap">DOB</th>
                                            <th class="whitespace-nowrap">GENDER</th>
                                            <th class="whitespace-nowrap">EDUCATION</th>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${listAccount}" var="la">
                                            <tr class="intro-x">
                                                <td class="text-center">${la.userID}</td>
                                                <td class="text-center">${la.username}</td>
                                                <td class="text-center">${la.password}</td>
                                                <td class="text-center">${la.roleID}</td>
                                                <td class="text-center">${la.fullName}</td>
                                                <td class="text-center">${la.address}</td>
                                                <td class="text-center">${la.aboutMe}</td>
                                                <td class="text-center">${la.dob}</td>
                                                <td class="text-center">${la.gender}</td>
                                                <td class="text-center">${la.education}</td>
                                                <td class="w-40">
                                                  
                                                  <div class="flex">
                                                    
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5"><img src="${la.img}" ></div>
                                                  </div>
                                                </td> 
<!--                                                <td class="text-center"> $ {la. img}</td>-->
                                                <td class="text-center">${la.email}</td>
                                                <td class="w-40">
                                                    <c:choose>
                                                        <c:when test="${la.active=='0'}">
                                                ...
                                                <td class="table-report__action w-56">
                                                    <div class="flex justify-center items-center"><a class="flex items-center mr-3" href="#"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                        ...
                                                        <a class="flex items-center text-danger" href="UserListDelete?userId=${la.userID}"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                                class="lucide w-4 h-4 mr-1">
